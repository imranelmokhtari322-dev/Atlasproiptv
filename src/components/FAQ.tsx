    ...
    <section className="bg-green-50 text-green-900 py-16 border-b-2 border-green-200" id="faq-section">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-xs uppercase font-sans text-green-600 font-bold tracking-widest bg-green-50 border border-green-200 px-3 py-1 rounded-full mb-3 inline-block">PREGUNTAS FRECUENTES</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold font-display tracking-tight text-green-900 mb-4">Preguntas frecuentes y respuestas</h2>
          <p className="text-green-600 text-sm sm:text-base">¿No encuentras tu pregunta? ¡Hazla por WhatsApp!</p>
        </div>
