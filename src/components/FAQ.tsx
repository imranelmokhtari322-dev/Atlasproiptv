...
export default function FAQ() {
  ...
  return (
    <section className="bg-dark-bg text-green-900 py-16 border-b border-green-100" id="faq-section">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-xs uppercase font-mono text-green-600 font-bold tracking-widest bg-green-50 border border-green-200 px-3 py-1 rounded-full mb-3 inline-block">VEELGESTELDE VRAGEN</span>
        ...
        <div className="mt-10 p-5 rounded-2xl bg-green-50 border border-green-200 inline-flex items-center gap-4 flex-col sm:flex-row justify-between w-full">
          ...
          <a href="https://wa.me/31600000000" target="_blank" rel="noreferrer"
            className="px-5 py-2.5 rounded-xl bg-green-600 hover:bg-green-700 text-white font-bold text-xs tracking-wide whitespace-nowrap text-center transition-colors">
            Stel via WhatsApp
          </a>
        </div>
      </div>
