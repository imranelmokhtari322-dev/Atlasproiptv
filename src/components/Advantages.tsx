...
export default function Advantages() {
  const cards = [
    ...
    {
      icon: <Monitor className="w-6 h-6 text-green-700" />,
  ...
  return (
    <section className="bg-dark-bg text-green-900 py-16 border-b border-green-100" id="advantages-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {cards.map((card, i) => (
            <div key={i} className="p-6 rounded-2xl border border-green-100 bg-white shadow-sm flex flex-col gap-4">
        ...
        <div className="text-center">
          <span className="text-xs uppercase font-mono text-green-600 font-bold tracking-widest bg-green-50 border border-green-200 px-3 py-1 rounded-full mb-6 inline-block">
